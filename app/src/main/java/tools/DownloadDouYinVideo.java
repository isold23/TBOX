...
public class DownloadDouYinVideo implements DownloadVideo{
    private final String TAG = "DownloadDouYinVideo";
    ...
    public void downloadVideo(Context context, String url) {
        ...
        mContext = context;
        //
        String new_url = url.substring(url.indexOf("https"));
